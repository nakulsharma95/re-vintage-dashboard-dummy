      ...
      <div>
        <div className={styles.topHeader}>
          ...
          <div className={styles.topHeaderBtnBox}>
            ...
            <Button variant="primary" className={`${styles.topHeaderBtn} ${styles.activeBtn}`}>
              All
            </Button>
                    ...
                    <Col md={7} className="ps-5">
                      ...
                      <Row>
                        <Col md={12}>
                          ...
                          <p className={`${styles.bikeCardBodyText} mb-0`}>
                            No F 26, 4, Pocket D, Okhla Phase II, New Delhi,
                            110020
                          </p>
                        </Col>
                      </Row>
...
export default MotorcycleDetailCard;
