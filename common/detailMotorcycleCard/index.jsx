...
import DetailDropCard from "common/detailDropCard";
              ...
              <Row>
                <Col lg={6} md={12} sm={12}>
                  <div className={styles.vehicleDetail}>
                    ...
                    <div class={styles.Estimatedprice}>
                ...
                <Col lg={6} md={12} sm={12}>
                  <div class={styles.evaluation}>
                    <h5 class="mb-3 text-white-50">Evaluation Details</h5>

                    <div class="location eval mb-3">
                      <p>Evaluation Location</p>
                      <h5>Neel Motors, Lajpat Nagar, Delhi</h5>
                    </div>
                    <div class="owner-name eval mb-3">
                      <p>Owner Details</p>
                      <h5>Rishab Sharma</h5>
                    </div>
                    <div class="conct eval mb-3">
                      <p>Contact No.</p>
                      <h5>+91 98765 43219</h5>
                    </div>
                    <div class="date-&-time eval mb-3">
                      <p>Contact No.</p>
