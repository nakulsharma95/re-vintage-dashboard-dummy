...
export default function Notification() {
  const obj = [
...

    {
      ...
      subHeading:
        'This is to notify you that a new bid is coming up soon on the bidding portal, Please keep an eye on that.',
      days: '21 Sept 2022',
      badgeSpan: 'New',
      isBadgeVisible: false,
      isCheckIconVisible: false,
  ...
  return (
    <div>
      ...
      <HeaderPrimary headerClass="mb-2" title="Notification" />
