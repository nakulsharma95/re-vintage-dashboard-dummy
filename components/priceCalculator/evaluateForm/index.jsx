			...
			<Form className={styles.evaluteFormMain}>
				<div className="d-flex">
					<Form.Group className={styles.formGroup}>
						...
						<span className={styles.iconImg}><Image src="/images/icons/bike-white.svg" alt="" /></span>
					</Form.Group>
					<Form.Group className={styles.formGroup}>
					...
					<Form.Group className={styles.formGroup}>
						...
						<span className={styles.iconImg}><Image src="/images/icons/calendar.svg" alt="" /></span>
					</Form.Group>
					<Form.Group className={styles.formGroup}>
						<Form.Control type="text" placeholder="Owner" />
						<span className={styles.iconImg}><Image src="/images/icons/user.svg" alt="" /></span>
					</Form.Group>
					<Form.Group className={styles.formGroup}>
