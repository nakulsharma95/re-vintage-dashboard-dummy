			...
			<Modal.Body className={styles.leadsModalBody}>
					...
					<div className={styles.headFlex}>
						...
						<div className={styles.rightFlexCols}>
							<div className={styles.rightCols}>
								<li><span>Primary source:</span> MIY</li>
								<li><span>Secondary source:</span> Google</li>
							</div>
							<Button variant="" onClick={props.handleClose}><FaTimes /> Close</Button>
						</div>
					</div>
				</div>
				...
				<div className={styles.userInfo}>
					<div className={styles.connectUser}>
						<Link href="/"><BiPhoneCall /> Call</Link>
						<Link href="/"><BsChatLeft /> Message</Link>
						<Link href="/"><FiMail /> Mail</Link>
						<Link href="/"><BsWhatsapp /> Whatsapp</Link>
					</div>
					<div className={styles.connectUser}>
						<Link href="/"><FaRegClipboard /> Send evaluation form</Link>
					</div>
				</div>
				<div className="mt-5">
					<BikeHistory />
