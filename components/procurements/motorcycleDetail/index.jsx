...
import AcceptModal from '../../../components/modals/cancelModal';
      ...
      >
        ...
        {props.isClosedPrice && (
          <div className={styles.closedBidPrice}>
            <div className={styles.motorsDetails}>
              <span>Current highest bid by</span>
              <Button variant="" onClick={cancelToggleModal}>{props.highestBidPrice}</Button>
            </div>
        ...
        {props.isUpcomingBidDetail && (
          <div className={styles.upcomingDetailPrice}>
            ...
            <div className="d-flex">
              <div className={styles.priceCols}><BiRupee /> 1,20,000.00</div>
        ...
        {props.isSellerBidDetail && (
          <div className={styles.sellerDetailPrice}>
            <div className={styles.priceCols}>
              <div className={styles.title}>Base Price: </div> <BiRupee /> 1,25,000.00
            </div>
