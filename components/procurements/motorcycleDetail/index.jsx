...
function MotorcycleDetail({ bikeName, headBikeDetail, bikeInfo, bikeNumber, detailMenu, chasisNumber, detailLocation, bikeDetailTitle, bikePriceTitle, footerPrice }) {
  return (
    <div
    ...
    >
      <div className="mb-4">
        ...
        {detailMenu && (
          <Button variant="" className={styles.bikeDetailInfoIcon}><BiDotsVerticalRounded /></Button>
        )}
      </div>
      {bikeDetailTitle && (
        <Row>
      ...
      <div className="d-flex align-items-center mt-3">
        <div className={styles.bikeRupeeIcon}><BiRupee /></div>
          <div>
        ...
        {footerPrice && (
          ...
          <div className={styles.priceTag}><BiRupee /> 1,25,000.00</div>
