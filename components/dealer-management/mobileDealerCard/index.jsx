  ...
  return (
	<div className={styles.dealerCard}>
		...
		<div className={styles.dealerCardHead}>
			...
			<p className={styles.dealerCardLocation}><HiOutlineLocationMarker className='mb-2' /> {props.location} </p>
		...
		<div className={styles.dealerCardFooter}>
			...
			<div className='d-flex'>
				<p className={`${styles.dealerContactNo} me-3`} ><BsTelephone className='mb-1' />{props.mobile} </p>
				<p className={`${styles.dealerContactNo} ms-3`}><AiOutlineMail className='mb-1' />{props.email} </p>
			</div>
		</div>
		</div>
